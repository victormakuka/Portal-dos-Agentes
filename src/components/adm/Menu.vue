...
<template>
  <div class="fixed">
    ...
    <div class="flex h-screen relative">
      ...
      <div
        :class="[
          'fixed top-0 left-0 h-full lg:w-1/4 w-2/3 bg-orange-500 lg:text-xl text-white p-4 transition-transform duration-300 ease-in-out z-40 rounded-r-md shadow-lg',
      ...
      >
        ...
        <div
          class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-400 cursor-pointer hover:bg-orange-500 text-white whitespace-nowrap"
          @click="toggleSubmenu"
          id="paraCima"
        >
        <!-- Submenu DE Gerenciamento de Agentes -->
          <span class="hover:text-orange-100 flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
             ...
             Gerenciar Agentes
            <svg :class="['transition-transform', submenuAberto ? 'rotate-180' : 'rotate-0']" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <!-- A linha que separa Terminar sessão, Difinição com os demais -->
